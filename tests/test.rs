...
fn returns_a_malformed_record_error_for_records_short_on_values() {
    let short_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 200 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1" "#;
...
fn returns_a_parsing_error_referencing_the_sent_bytes_when_the_sent_bytes_is_malformed() {
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 0.145507 0.00003 200 200 0 bad_sent_bytes "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
{
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 0.145507 0.00003 200 200 bad_received_bytes 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
fn returns_a_parsing_error_when_the_backend_status_code_is_malformed() {
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 0.145507 0.00003 200 bad_backend_status_code 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
fn returns_a_parsing_error_when_the_elb_status_code_is_malformed() {
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 0.145507 0.00003 bad_elb_status_code 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
fn returns_a_parsing_error_when_the_response_processing_time_is_malformed() {
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 0.145507 bad_response_processing_time 200 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
fn returns_a_parsing_error_when_the_backend_processing_time_is_malformed() {
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 bad_backend_processing_time 0.00003 200 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
fn returns_a_parsing_error_when_the_request_processing_time_is_malformed() {
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 172.16.1.5:9000 bad_request_processing_time 0.145507 0.00003 200 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
fn returns_a_parsing_error_when_the_backend_address_is_malformed() {
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name 172.16.1.6:54814 bad_backend_address 0.000039 0.145507 0.00003 200 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
{
    let bad_record = r#"2015-08-15T23:43:05.302180Z elb-name bad_client_address 172.16.1.5:9000 0.000039 0.145507 0.00003 200 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
...
fn returns_a_parsing_error_referencing_the_timestamp_when_the_timestamp_is_malformed() {
    let bad_record = r#"bad_timestamp elb-name 172.16.1.6:54814 172.16.1.5:9000 0.000039 0.145507 0.00003 200 200 0 7582 "GET http://some.domain.com:80/path0/path1?param0=p0&param1=p1 HTTP/1.1""#;
